...
- [Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks (Lewis et al., 2020)](https://arxiv.org/abs/2005.11401) - RAG原始论文
- [What is retrieval-augmented generation (RAG)? (McKinsey, 2024)](https://www.mckinsey.com/featured-insights/mckinsey-explainers/what-is-retrieval-augmented-generation-rag) - RAG企业应用解释
- [What is Retrieval Augmented Generation? (IBM)](https://www.ibm.com/think/topics/retrieval-augmented-generation) - RAG连接外部知识库的基本机制
- [ChatGPT plugins (OpenAI, 2023)](https://openai.com/blog/chatgpt-plugins) - ChatGPT接入浏览器、代码解释器和第三方插件
- [Function calling and other API updates (OpenAI, 2023)](https://openai.com/index/function-calling-and-other-api-updates/) - OpenAI API支持function calling
- [LangChain (official)](https://www.langchain.com/langchain) - LLM应用与Agent开发框架
- [AutoGPT (Wikipedia)](https://en.wikipedia.org/wiki/AutoGPT) - 2023年3月发布的自主Agent项目
- [Introducing Operator (OpenAI, 2025)](https://openai.com/index/introducing-operator/) - OpenAI浏览器操作Agent
- [Introducing ChatGPT agent (OpenAI, 2025)](https://openai.com/index/introducing-chatgpt-agent/) - ChatGPT agent整合Operator、Deep Research和工具执行
- [Computer use tool (Anthropic Docs)](https://docs.claude.com/en/docs/agents-and-tools/tool-use/computer-use-tool) - Claude computer use能力
- [Connect to external tools with MCP (Claude Code Docs)](https://code.claude.com/docs/en/agent-sdk/mcp) - MCP连接外部工具和数据源
- [Introducing GPT-4o (OpenAI, 2024)](https://openai.com/index/gpt-4o-and-more-tools-to-chatgpt-free/) - GPT-4o多模态能力
- [Sora is here (OpenAI, 2024)](https://openai.com/blog/sora-is-here/) - Sora从研究预览进入产品
- [Fuel your creativity with new generative media models and tools (Google, 2025)](https://blog.google/technology/ai/generative-media-models-io-2025/) - Google发布Veo 3、Imagen 4、Flow
- [Gartner predicts 40% of enterprise apps will feature task-specific AI agents by 2026](https://www.gartner.com/en/newsroom/press-releases/2025-08-26-gartner-predicts-40-percent-of-enterprise-apps-will-feature-task-specific-ai-agents-by-2026-up-from-less-than-5-percent-in-2025) - 企业应用Agent渗透率预测
- [Gartner predicts over 40% of agentic AI projects will be canceled by end of 2027](https://www.gartner.com/en/newsroom/press-releases/2025-06-25-gartner-predicts-over-40-percent-of-agentic-ai-projects-will-be-canceled-by-end-of-2027) - Agent项目落地风险
- [The state of AI in 2025 (McKinsey)](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) - 企业AI与Agent采用数据
- [Salesforce Agentforce 2dx (Salesforce, 2025)](https://investor.salesforce.com/news/news-details/2025/Salesforce-Launches-Agentforce-2dx-with-New-Capabilities-to-Embed-Proactive-Agentic-AI-into-Any-Workflow-Create-Multimodal-Experiences-and-Extend-Digital-Labor-Throughout-the-Enterprise/default.aspx) - SaaS厂商Agent化案例
- [Software Developers, Quality Assurance Analysts, and Testers (BLS, 2025)](https://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm) - 软件开发、测试和QA岗位2024到2034年就业预测
- [Generative AI reshapes U.S. job market, Stanford study shows (CNBC, 2025)](https://www.cnbc.com/2025/08/28/generative-ai-reshapes-us-job-market-stanford-study-shows-entry-level-young-workers.html) - 生成式AI对年轻员工和入门岗位的冲击
