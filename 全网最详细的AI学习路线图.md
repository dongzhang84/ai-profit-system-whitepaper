...
那种"数学 → ML 基础 → DL → 选方向 → 做项目"五大阶段、两百条目录的路线图，有三个硬伤：

1. **不问你的目标，就上来给答案**。研究算法、找工作、大概了解，这三个目标对应的路线完全不一样。一份通用路线图意味着哪个具体场景都覆盖不了
2. **按论文作者的综述顺序排，不适合学习者**。你啃完所谓"基础"要半年，还没写过一行能跑的代码，半路崩盘是常态
3. **很多长得吓人的路线图本质是软文**。先把你吓住，再端出"救你命"的课程链接。你以为在学 AI，其实在被转化漏斗

我给你的路线图反过来：**先定目标，再选方向，再挑一个能 ship 的项目，倒推要学什么**。

# 简单介绍一下我自己

我本科物理专业，年级第一。硕博读的天体物理，一度以为这辈子就做物理学家了。后来我判断整个物理学科已经走进死胡同，果断转 AI。
